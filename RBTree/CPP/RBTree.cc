...
/////////////////////////////////////////////////////////////////////////
bool RBTree::leftRotated(Node** root, Node* nodeShouldRotated)
{
  if (*root == NULL || nodeShouldRotated == NULL) {
    return false;
  }
  Node* rightChild = nodeShouldRotated->right;  // y <- right[x]
...
bool RBTree::rightRotated(Node** root, Node* nodeShouldRotated)
{
  if (*root == NULL || nodeShouldRotated == NULL) {
    return false;
  }
  Node* leftChild = nodeShouldRotated->left;  // y <- left[x]
